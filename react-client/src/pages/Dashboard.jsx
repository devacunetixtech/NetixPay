    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/dashboard" className="text-sm text-blue-600 font-semibold leading-6 text-gray-900">
            Dashboard
          </a>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a href="/dashboard"
                  className="-mx-3 block rounded-lg px-3 text-blue-600 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                  Dashboard
                </a>
                <a href="/profile"
