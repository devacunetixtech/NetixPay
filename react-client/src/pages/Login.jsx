    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/login" className="text-sm text-blue-600 font-semibold leading-6 text-gray-900">
            Log In
          </a>
          ...
          <div className={styles.glass} >
            ...
            <form className='py-1'>
              ...
              <div className="textbox flex flex-col items-center gap-6">
                ...
                <button className="border bg-blue-400 w-3/4 py-3 rounded-lg text-gray-50 text-xl shadow-sm text-center" type='submit'>Login....</button>
              </div>
