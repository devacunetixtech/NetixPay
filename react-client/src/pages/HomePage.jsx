  ...
  return (
    ...
    <header className="bg-blue-200">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          ...
          <a href='/' className="text-xl text-gray-900 text-center font-bold">NetixPay</a>
        </div>
    ...
    <div className="min-h-screen px-2">
      <header className="py-3">
        <h1 className="text-3xl text-gray-800 text-center font-bold">Welcome to NetixPay</h1>
      </header>
      <main className="container mx-auto py-8">
        <section className="mb-8">
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4">Open an Account</button>
        </section>
        <section className="mb-8">
        ...
        <section>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4">Contact Support</button>
        </section>
      </main>
      <footer className="py-4">
        <p className="text-gray-600 text-center">&copy; {new Date().getFullYear()} NetixPay. All rights reserved.</p>
      </footer>
    </div>
    </>
  );
