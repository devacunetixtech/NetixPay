    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="profile" className="text-sm text-blue-600 font-semibold leading-6 text-gray-900">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a href="/profile"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base text-blue-600 font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                  Profile
                </a>
